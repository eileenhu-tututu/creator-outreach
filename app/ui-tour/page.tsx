/* oxlint-disable next/no-html-link-for-pages, next/no-img-element -- Full route loads and direct images avoid Vinext client-runtime duplication. */
    ...
    <main className="app-shell min-h-screen text-foreground">
      ...
      <section className="ds-cover">
        ...
        <div className="ds-cover-phones" aria-label="Three core interface previews">
          <div className="ds-phone ds-phone-left"><div className="ds-phone-notch" /><small>CREATOR SIGNALS</small><img src={creatorImage} alt="Creator content screen" /><div className="ds-phone-caption"><b>@rainydayrachel</b><span>3 scripts ready</span></div><div className="ds-mini-progress"><i style={{ width: '32%' }} /></div></div>
          ...
          <div className="ds-phone ds-phone-right"><div className="ds-phone-notch" /><small>OUTREACH READY</small><div className="ds-email-mini"><div><img src={senderImage} alt="Email sender" /><span><b>Mia</b><small>to Rachel</small></span></div><strong>Rainy-day style ☔</strong><p>Your recent video gave us a specific collaboration idea…</p><button type="button">Review email <ArrowRight /></button></div><div className="ds-mini-progress"><i style={{ width: '100%' }} /></div></div>
        </div>
      ...
      <section className="ds-screens-section">
        <div className="ds-page-width">
          ...
          <div className="ds-screen-stage">
            ...
            <article className="ds-screen ds-screen-creator"><div className="ds-screen-top"><span>9:41</span><b>● ●</b></div><div className="ds-screen-progress"><i style={{ width: '34%' }} /></div><small>01 / CREATOR CONTENT</small><h3>Understand the creator</h3><div className="ds-profile-row"><img src={creatorImage} alt="Creator profile" /><span><b>@rainydayrachel</b><small>Seattle · daily fits</small></span><em>READY</em></div><div className="ds-video-grid"><img src={creatorImage} alt="Creator video" /><img src={creatorImage} alt="Creator video" /><img src={creatorImage} alt="Creator video" /></div><div className="ds-transcript"><small>VIDEO 01 · TRANSCRIPT</small><p>“I need a jacket that is actually waterproof and cute…”</p></div></article>

            <article className="ds-screen ds-screen-match"><div className="ds-screen-top"><span>9:41</span><b>● ●</b></div><div className="ds-screen-progress"><i style={{ width: '68%' }} /></div><small>02 / PRODUCT MATCH</small><h3>Find the strongest fit</h3><div className="ds-product-visual"><img src={productImage} alt="Matched product" /><div><b>CloudLayer Jacket</b><span>Waterproof · lightweight</span></div><em>94%</em></div><div className="ds-reason-card"><PackageSearch /><p><b>Why it fits</b><span>Matches rainy weather, outfit styling and daily commute signals.</span></p></div><button type="button">Product selected <Check /></button></article>

            <article className="ds-screen ds-screen-mail"><div className="ds-screen-top"><span>9:41</span><b>● ●</b></div><div className="ds-screen-progress"><i style={{ width: '100%' }} /></div><small>03 / OUTREACH</small><h3>Personalized outreach</h3><div className="ds-mail-card"><div className="ds-mail-from"><img src={senderImage} alt="Mia" /><span><b>Mia at Northstar</b><small>To @rainydayrachel</small></span><Mail /></div><span className="ds-mail-label">SUBJECT</span><strong>Rainy-day style, made lighter ☔</strong><p>Your Seattle rain moment felt like the perfect fit for CloudLayer…</p><span className="ds-mail-cta">View creator offer</span></div><button type="button">Send HTML email <Send /></button></article>
          </div>
        </div>
      </section>
